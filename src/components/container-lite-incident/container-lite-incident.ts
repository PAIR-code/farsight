...
import componentCSS from '../container-lite/container-lite.scss?inline';
 ...
 */
@customElement('farsight-container-lite-incident')
export class FarsightContainerLiteIncident extends LitElement {
  // ===== Class properties ======
  ...
  firstUpdated() {
    ...
    if (this.containerElement) {
      ...
      // if (bbox.height < 510) {
      //   MAX_ACCIDENTS_PER_PAGE = 4;
      // } else if (bbox.height < 750) {
      //   MAX_ACCIDENTS_PER_PAGE = 5;
      // }
    }
...
declare global {
  interface HTMLElementTagNameMap {
    'farsight-container-lite-incident': FarsightContainerLiteIncident;
  }
}
