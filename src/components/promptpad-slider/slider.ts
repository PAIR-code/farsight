 ...
 *
 */
@customElement('promptpad-slider')
export class PromptPadSlider extends LitElement {
  // ===== Class properties ======
  ...
  firstUpdated() {
    ...
    // Update the thumb to reflect the initial value
...
declare global {
  interface HTMLElementTagNameMap {
    'promptpad-slider': PromptPadSlider;
  }
}
