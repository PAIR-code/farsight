 ...
 *
 */
@customElement('farsight-demo-page-lite-incident')
export class FarsightDemoPageLiteIncident extends LitElement {
  // ===== Class properties ======
  @state()
  prompt = '';
      ...
      return html`
        <div class="demo-page-lite">
          ...
          <div class="lite-content">
            <farsight-container-lite-incident
...
declare global {
  interface HTMLElementTagNameMap {
    'farsight-demo-page-lite-incident': FarsightDemoPageLiteIncident;
  }
}
