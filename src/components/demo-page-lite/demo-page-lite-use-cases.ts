 ...
 *
 */
@customElement('farsight-demo-page-lite-use-cases')
export class FarsightDemoPageLiteUseCases extends LitElement {
  // ===== Class properties ======
  @state()
  prompt = '';
      ...
      return html`
        <div class="demo-page-lite">
          ...
          <div class="lite-content">
            <farsight-container-lite-use-cases
...
declare global {
  interface HTMLElementTagNameMap {
    'farsight-demo-page-lite-use-cases': FarsightDemoPageLiteUseCases;
  }
}
