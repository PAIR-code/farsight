 ...
 */
@customElement('farsight-container-lite-use-cases')
export class FarsightContainerLiteUseCases extends LitElement {
  // ===== Class properties ======
...
declare global {
  interface HTMLElementTagNameMap {
    'farsight-container-lite-use-cases': FarsightContainerLiteUseCases;
  }
}
