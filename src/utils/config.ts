...
const BUILD_MODES = new Set(['x20', 'library', 'production']);
const PROD_MODE = BUILD_MODES.has(import.meta.env.MODE);
...
const layout = {
  treeLayout: {
    ...
    vGap: 30,
    shortVGap: 15,
    expandedSummaryWidth: 400,
    animationDuration: 800
  }
};

const score = {
  warnLowThreshold: 0.65,
  alertLowThreshold: 0.75
};

const urls = {
  errorImage: 'https://i.imgur.com/sVBAlIU.jpg',
  accidentReports:
    'https://xiaohk.github.io/accident-data/accident-reports.json',
  accidentEmbeddingCompressed:
    'https://xiaohk.github.io/accident-data/accident-report-embeddings.json.gzip'
};
